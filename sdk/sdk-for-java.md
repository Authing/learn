...
![&#x521B;&#x5EFA;&#x9879;&#x76EE; - 1](https://cdn.authing.cn/blog/20200311011537.png)
...
![&#x521B;&#x5EFA;&#x9879;&#x76EE; - 3](https://cdn.authing.cn/blog/20200311011746.png)

![&#x521B;&#x5EFA;&#x9879;&#x76EE; - 4](https://cdn.authing.cn/blog/20200311011811.png)

### 添加依赖

进入 IDE，等待 Gradle 构建完毕，打开 build.gradle 文件：

![&#x6253;&#x5F00; build.gradle &#x6587;&#x4EF6;](https://cdn.authing.cn/blog/20200311011901.png)
...
![&#x5F00;&#x542F; Auto-import](https://cdn.authing.cn/blog/20200311012019.png)

### 开始使用

在 java 文件夹下创建一个 Class，命名为 Demo。

![&#x521B;&#x5EFA; Java Class](https://cdn.authing.cn/blog/20200311012211.png)
...
* params {Object}
  * params.client\_id {String}，必填，OIDC 应用 ID
  * params.client\_secret {String}，必填，OIDC 应用密钥
...
* params {Object}
  * params.client\_id {String}，必填，OIDC 应用 ID
  * params.client\_secret {String}，必填，OIDC 应用密钥
  * params.refresh\_token {String}，必填，刷新 token
...
* params {Object}
  * [params.email](http://params.email/) {String}，必填，邮箱地址
