...
* [接入单点登录](advanced/sso/README.md)
  ...
  * [使用 OAuth 2.0](advanced/sso/oauth2/README.md)
    * [创建 OAuth 应用](advanced/sso/oauth2/create-oauth2.md)
    * [使用 OAuth 授权](advanced/sso/oauth2/oauth-authorization.md)
  * [使用 OpenID Connect](advanced/sso/oidc/README.md)
    * [创建 OIDC 应用](advanced/sso/oidc/create-oidc.md)
