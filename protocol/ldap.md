---
description: 学习 LDAP 的基础知识以及如何在 Authing 中配置 LDAP。
---
...
使用 LDAP 服务请先[创建一个 OAuth 应用](https://docs.authing.cn/#/oauthProvider/new)或[创建一个 OIDC 应用](https://docs.authing.cn/#/OIDCProvider/authorize?id=在-a-应用第三方登录选项卡下创建-oidc-应用)。
...
![https://usercontents.authing.cn/docs/oauth/ldap/ldap\_test.png](https://usercontents.authing.cn/docs/oauth/ldap/ldap_test.png)
...
![https://usercontents.authing.cn/docs/oauth/ldap/user\_verify.png](https://usercontents.authing.cn/docs/oauth/ldap/user_verify.png)
